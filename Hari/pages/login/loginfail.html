...
<html lang="en">
  ...
  <body>
    ...
    <form method="POST" action="authmain.php" id="logform">
      ...
      <label class='login-failed'>Unable to Login. Try again!</label>
      ...
      <input type="button" value="Register" class="custom-button" onclick="window.location.href='../../pages/register/register.html';">
    </form>
  </body>
